...
#
# llm_project2.tcl: Tcl script for re-creating project 'llm_project'
#
# Generated by Vivado on Fri Mar 29 21:27:45 -0400 2024
...
#
# 1. This project restoration tcl script (llm_project2.tcl) that was generated.
#
...
#    "c:/Users/Max/Desktop/tinyllm-fpga/ip_repo/blk_mem_gen_0/blk_mem_gen_0.xci"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/checkpoints/synth_1/simple_dma_wrapper.dcp"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/llm_project/[file normalize "$origin_dir/ip_repo/matmul_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "llm_project2.tcl"
...
\
  ...
  # Create instance: matmul_0_bram, and set properties
  set matmul_0_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 matmul_0_bram ]
  set_property -dict [list \
    CONFIG.Byte_Size {8} \
  ...
  connect_bd_intf_net -intf_net axi_dma_M_AXI_S2MM [get_bd_intf_pins axi_dma/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon_1/S00_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_1_M00_AXI [get_bd_intf_pins axi_mem_intercon_1/M00_AXI] [get_bd_intf_pins processing_system7/S_AXI_HP2]
  ...
  connect_bd_intf_net -intf_net matmul_0_bram1 [get_bd_intf_pins matmul_0_bram/BRAM_PORTA] [get_bd_intf_pins matmul_0/bram]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins matmul_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_pins processing_system7/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins processing_system7/S_AXI_HP2_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins matmul_0/s00_axi_aclk] [get_bd_pins matmul_0/axis_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins matmul_0/s00_axi_aresetn] [get_bd_pins matmul_0/axis_aresetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs processing_system7/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_S2MM] [get_bd_addr_segs processing_system7/S_AXI_HP2/HP2_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs matmul_0/S00_AXI/S00_AXI_reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.805821",
   "Default View_TopLeft":"369,53",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2100 -y 460 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2100 -y 490 -defaultsOSRD
preplace inst axi_dma -pg 1 -lvl 4 -x 1160 -y 140 -defaultsOSRD
preplace inst processing_system7 -pg 1 -lvl 6 -x 1850 -y 520 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 520 -y 240 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 190 -y 350 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -x 1500 -y 140 -defaultsOSRD
preplace inst axi_mem_intercon_1 -pg 1 -lvl 5 -x 1500 -y 520 -defaultsOSRD
preplace inst matmul_0 -pg 1 -lvl 3 -x 830 -y 150 -defaultsOSRD
preplace inst matmul_0_bram -pg 1 -lvl 4 -x 1160 -y 310 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 20 250 360 90 690 310 990 380 1340 640 1640 640 2060
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 20 450 NJ 450 NJ 450 NJ 450 1350J 400 NJ 400 2070
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 370 100 660 320 1000 390 1360
preplace netloc axi_dma_M_AXIS_MM2S 1 2 3 700 290 960J 20 1320
preplace netloc axi_dma_M_AXI_MM2S 1 4 1 N 80
preplace netloc axi_dma_M_AXI_S2MM 1 4 1 1330 100n
preplace netloc axi_mem_intercon_1_M00_AXI 1 5 1 N 520
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 1640 140n
preplace netloc matmul_0_M00_AXIS 1 3 1 1000 70n
preplace netloc matmul_0_bram1 1 3 1 970J 90n
preplace netloc processing_system7_0_DDR 1 6 1 2080J 460n
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ 490
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 380 10 NJ 10 NJ 10 NJ 10 NJ 10 2060
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 2 670 300 980J
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 680 100n
levelinfo -pg 1 0 190 520 830 1160 1500 1850 2100
pagesize -pg 1 -db -bbox -sgen 0 0 2210 720
"
}
