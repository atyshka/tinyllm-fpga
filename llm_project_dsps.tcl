...
#
# llm_project_dsps.tcl: Tcl script for re-creating project 'llm_project'
#
# Generated by Vivado on Sat Apr 06 17:12:43 -0400 2024
...
#
# 1. This project restoration tcl script (llm_project_dsps.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "F:/tinyllm-fpga/llm_project/llm_project.srcs/utils_1/imports/synth_1/simple_dma_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "F:/tinyllm-fpga/ip_repo/matmul_0/matmul_0.xci"
#    "F:/tinyllm-fpga/ip_repo/blk_mem_dp_32_1024/blk_mem_dp_32_1024.xci"
#    "F:/tinyllm-fpga/test.coe"
#    "F:/tinyllm-fpga/hdl/matmul_tb.vhd"
#    "F:/tinyllm-fpga/checkpoints/synth_1/simple_dma_wrapper.dcp"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/ip_repo/blk_mem_dp_32_1024/blk_mem_dp_32_1024.xci"]"\
 "[file normalize "$origin_dir/test.coe"]"\
 "[file normalize "$origin_dir/hdl/matmul_tb.vhd"]"\
 "[file normalize "$origin_dir/checkpoints/synth_1/simple_dma_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
   [file normalize "$origin_dir/ip_repo/matmul_1_0"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "llm_project"
...
set script_file "llm_project_dsps.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/llm_project"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/matmul_1_0"]" $obj
...
set file "$origin_dir/ip_repo/matmul_0/matmul_0.xci"
...
set file "$origin_dir/ip_repo/blk_mem_dp_32_1024/blk_mem_dp_32_1024.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set_property -name "top" -value "simple_dma_wrapper" -objects $obj
...
set file "$origin_dir/hdl/matmul_tb.vhd"
set file [file normalize $file]
...
set_property -name "top" -value "matmul_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
# Proc to create BD simple_dma
proc cr_bd_simple_dma { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name simple_dma
...
# Hierarchical cell: matmul_memory
proc create_hier_cell_matmul_memory { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_matmul_memory() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 bram
  ...
  set_property CONFIG.WEIGHT_TDATA_WIDTH {32} $matmul_0
  ...
  connect_bd_intf_net -intf_net axi_cdma_0_M_AXI [get_bd_intf_pins M_AXI] [get_bd_intf_pins axi_cdma_0/M_AXI]
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins matmul_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins S00_AXI] [get_bd_intf_pins matmul_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins S_AXI_LITE1] [get_bd_intf_pins axi_cdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net matmul_0_M00_AXIS [get_bd_intf_pins matmul_0/M00_AXIS] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net matmul_0_bram [get_bd_intf_pins bram] [get_bd_intf_pins matmul_0/bram]

  # Create port connections
  connect_bd_net -net axi_cdma_0_cdma_introut [get_bd_pins axi_cdma_0/cdma_introut] [get_bd_pins cdma_introut]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins s_axi_lite_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins matmul_0/s00_axi_aclk] [get_bd_pins matmul_0/axis_aclk]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins matmul_0/s00_axi_aresetn] [get_bd_pins matmul_0/axis_aresetn]
...
\
  ...
  # Create instance: matmul_memory
  create_hier_cell_matmul_memory [current_bd_instance .] matmul_memory
  ...
  connect_bd_intf_net -intf_net axi_cdma_0_M_AXI [get_bd_intf_pins matmul_memory/M_AXI] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_M_AXI_MM2S [get_bd_intf_pins matmul_memory/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_M_AXI_S2MM [get_bd_intf_pins matmul_memory/M_AXI_S2MM] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins processing_system7/S_AXI_HP1]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M01_AXI [get_bd_intf_pins axi_mem_intercon/M01_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins matmul_memory/S00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins matmul_memory/S_AXI_LITE1]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins matmul_memory/S_AXI_LITE]
  connect_bd_intf_net -intf_net matmul_0_bram [get_bd_intf_pins matmul_memory/bram] [get_bd_intf_pins axi_bram_ctrl_0_bram/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net processing_system7_M_AXI_GP0 [get_bd_intf_pins processing_system7/M_AXI_GP0] [get_bd_intf_pins axi_smc/S00_AXI]

  # Create port connections
  connect_bd_net -net axi_cdma_0_cdma_introut [get_bd_pins matmul_memory/cdma_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_pins processing_system7/M_AXI_GP0_ACLK] [get_bd_pins processing_system7/S_AXI_HP0_ACLK] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins processing_system7/S_AXI_HP1_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins matmul_memory/s_axi_lite_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins matmul_memory/axi_resetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins processing_system7/IRQ_F2P]

  # Create address segments
  assign_bd_address -offset 0x7E200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs matmul_memory/axi_cdma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs matmul_memory/axi_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs matmul_memory/matmul_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces matmul_memory/axi_dma/Data_MM2S] [get_bd_addr_segs processing_system7/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces matmul_memory/axi_dma/Data_S2MM] [get_bd_addr_segs processing_system7/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces matmul_memory/axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces matmul_memory/axi_cdma_0/Data] [get_bd_addr_segs processing_system7/S_AXI_HP0/HP0_DDR_LOWOCM] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.09312",
   "Default View_TopLeft":"669,1",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2870 -y 720 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2870 -y 740 -defaultsOSRD
preplace inst processing_system7 -pg 1 -lvl 5 -x 2330 -y 770 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 5 -x 2330 -y 990 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 6 -x 2720 -y 1060 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -x 1930 -y 960 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 520 -y 490 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1930 -y 780 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 4 -x 1930 -y 430 -defaultsOSRD
preplace inst matmul_memory -pg 1 -lvl 3 -x 920 -y 100 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 190 -y 590 -defaultsOSRD
preplace inst matmul_memory|matmul_0 -pg 1 -lvl 1 -x 1030 -y 300 -defaultsOSRD
preplace inst matmul_memory|axi_dma -pg 1 -lvl 2 -x 1400 -y 200 -defaultsOSRD
preplace inst matmul_memory|axi_cdma_0 -pg 1 -lvl 2 -x 1400 -y 520 -defaultsOSRD
preplace netloc axi_cdma_0_cdma_introut 1 3 1 1740 530n
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 490 370 410 680 640 1780 640 2090 640 2570
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 360 400 690 650 1760 1020 2080J
preplace netloc xlconcat_0_dout 1 4 1 2100J 840n
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 690 NJ 690 NJ 690 1770J 620 NJ 620 2580
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 5 1 2560 990n
preplace netloc axi_cdma_0_M_AXI 1 3 1 1750 510n
preplace netloc axi_dma_M_AXI_MM2S 1 3 1 N 340
preplace netloc axi_dma_M_AXI_S2MM 1 3 1 N 360
preplace netloc axi_interconnect_0_M00_AXI 1 4 1 2100 430n
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 2080 740n
preplace netloc axi_mem_intercon_M01_AXI 1 4 1 2080 790n
preplace netloc axi_smc_M00_AXI 1 2 1 660 50n
preplace netloc axi_smc_M01_AXI 1 2 1 N 490
preplace netloc axi_smc_M02_AXI 1 2 1 670 70n
preplace netloc matmul_0_bram 1 3 3 1780 280 NJ 280 2590J
preplace netloc processing_system7_0_DDR 1 5 2 NJ 720 NJ
preplace netloc processing_system7_0_FIXED_IO 1 5 2 NJ 740 NJ
preplace netloc processing_system7_M_AXI_GP0 1 1 5 380 630 NJ 630 NJ 630 NJ 630 2560
preplace netloc matmul_memory|axi_cdma_0_cdma_introut 1 2 1 N 530
preplace netloc matmul_memory|processing_system7_0_FCLK_CLK0 1 0 2 840 500 1230
preplace netloc matmul_memory|rst_ps7_0_100M_peripheral_aresetn 1 0 2 850 510 1220
preplace netloc matmul_memory|axi_cdma_0_M_AXI 1 2 1 N 510
preplace netloc matmul_memory|axi_dma_M_AXIS_MM2S 1 0 3 850 60 NJ 60 1570
preplace netloc matmul_memory|axi_dma_M_AXI_MM2S 1 2 1 1590 140n
preplace netloc matmul_memory|axi_dma_M_AXI_S2MM 1 2 1 1580 160n
preplace netloc matmul_memory|axi_smc_M00_AXI 1 0 1 840 50n
preplace netloc matmul_memory|axi_smc_M01_AXI 1 0 2 NJ 490 N
preplace netloc matmul_memory|axi_smc_M02_AXI 1 0 2 NJ 70 1230
preplace netloc matmul_memory|matmul_0_M00_AXIS 1 1 1 N 170
preplace netloc matmul_memory|matmul_0_bram 1 1 2 1210J 80 1600J
levelinfo -pg 1 0 190 520 920 1930 2330 2720 2870
levelinfo -hier matmul_memory * 1030 1400 *
pagesize -pg 1 -db -bbox -sgen 0 0 2990 1130
pagesize -hier matmul_memory -db -bbox -sgen 810 30 1630 610
"
}
...
# End of cr_bd_simple_dma()

cr_bd_simple_dma ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files simple_dma.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files simple_dma.bd ] 
set_property IS_ENABLED "1" [get_files simple_dma.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files simple_dma.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files simple_dma.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files simple_dma.bd ] 
set_property PFM_NAME "" [get_files simple_dma.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files simple_dma.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files simple_dma.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files simple_dma.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files simple_dma.bd ] 
set_property USED_IN_SIMULATION "1" [get_files simple_dma.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files simple_dma.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list simple_dma.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/llm_project/llm_project.gen/sources_1/bd/simple_dma/hdl/simple_dma_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list simple_dma.bd]] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/llm_project.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/llm_project.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/llm_project.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
