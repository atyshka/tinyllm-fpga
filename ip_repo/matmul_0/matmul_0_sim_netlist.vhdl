...
architecture STRUCTURE of matmul_0_matmul_manager is
  ...
  signal first_done_i_2_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of first_done_i_1 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of result_ready_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of result_ready_i_4 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_6\ : label is "soft_lutpair3";
begin
  Q(0) <= \^q\(0);
...
first_done_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
first_done_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0FFFFFF00A80000"
    )
        port map (
      I0 => state1,
      I1 => s00_axis_tvalid,
...
result_ready_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
result_ready_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
result_ready_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEFFFFF"
    )
        port map (
...
result_ready_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
result_ready_i_9: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFDF"
    )
        port map (
